...
#define HOMING_DELAY_TIME_US 1500
#define MOTOR_DELAY_TIME_US 1500
...
int main(void)
{
  ...
  //motorStoppedByLimit[0] = limit_switch_states[0] ? true : false;
    //run_motor(3, 30.0 , 0, MOTOR_DELAY_TIME_US);
  //for(int i=0;i<4; i++){
    //home_motor(1,0);
    //home_motor(2,0);
    //home_motor(3,1);
    ...
    home_all_motors();
    HAL_Delay(50);
    run_motor(1, 20.0 , 1, MOTOR_DELAY_TIME_US);
    HAL_Delay(50);
    run_motor(2, 10.0 , 1, MOTOR_DELAY_TIME_US);
    HAL_Delay(50);
    run_motor(3, 10.0 , 0, MOTOR_DELAY_TIME_US);
    HAL_Delay(50);
    run_motor(4, 10.0 , 0, MOTOR_DELAY_TIME_US);
    HAL_Delay(50);
    run_motor(5, 10.0 , 1, MOTOR_DELAY_TIME_US);
    HAL_Delay(50);
    run_motor(6, 10.0 , 1, MOTOR_DELAY_TIME_US);
    HAL_Delay(50);
...
void run_motor(uint8_t motor_number, float value, uint8_t direction, uint16_t delay_time_us)
{
    ...
    //motorStoppedByLimit[motor_number -1] = limit_switch_states[motor_number-1] ? true : false;
...
void home_motor(uint8_t motor_number, uint8_t direction) {
    ...
    run_motor(motor_number, HOMING_STEP_DEGREE , inv_direction, HOMING_DELAY_TIME_US );
